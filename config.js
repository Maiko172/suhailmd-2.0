...
global.caption = process.env.CAPTION || global.caption || "© MaikoTechInfo" 


global.devs = "0684813143" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "0684813143";
...
global.scan = "https://maiko-md-vtsf.onrender.com";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "Maiko",
  packname: process.env.PACK_NAME || "Xd",
  botname : process.env.BOT_NAME  || "Maiko-XMD",
  ownername:process.env.OWNER_NAME|| "Maiko-X",
  ...
  LANG: ( process.env.THEME ||  "MAIKO"  ).toUpperCase(),
